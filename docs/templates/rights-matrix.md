...
| `[e.g., canonical-repository translation]` | `[book-repository contributors]` | `published translation`         | `[known holder]` | `[authorship / permission / license]`    | `[SPDX ID, URL, or status]` | `[book contributors; release link; license link; changes indicated]` | `approved-for-publication`                                                                                            | `[exact files or record IDs]`        | `[upstream release manifest]`         | `[none or limitations]`        |
